      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['40 m (7 MHz)', '✓', 'Acceso completo'],
            ['30 m (10 MHz)', '✗ No puede', 'Banda restringida para Novicio'],
            ['20 m (14 MHz)', '⚠️ Limitado', 'Solo puede operar en 14070–14099 kHz'],
            ['17 m (18 MHz)', '✗ No puede', 'Banda restringida para Novicio'],
            ['15 m (21 MHz)', '⚠️ Limitado', 'Solo en ALGUNOS segmentos (21070-21149 kHz y 21200-21310 kHz)'],
            ['12 m (24 MHz)', '✗ No puede', 'Banda restringida para Novicio'],
            ['10 m (28 MHz)', '✓', 'Acceso completo'],
            ['6 m (50 MHz)', '✓', 'Acceso completo'],
            ['2 m (144 MHz)', '✓', 'Acceso completo'],
            ['70 cm (430 MHz)', '✓', 'Acceso completo'],
            ['23 cm (1,2 GHz)', '✓', 'Acceso completo'],
          ]
        }
      },
      {
